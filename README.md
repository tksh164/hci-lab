...
| ---- | ---- | ---- |
| Azure Local 2504 (24H2) | The latest generally available version of Azure Local. | Available |
| Azure Local 2503 (23H2) | The previous version of Azure Local (formerly Azure Stack HCI). | Available |

...
namespace HciLab
{
    public static class OSSku
    {
        ...
        public const string AzureLocal24H2_2605 = "azloc24h2_2605";
        public const string AzureLocal24H2_2604 = "azloc24h2_2604";
...
function Get-Secret {
    ...
    for ($attempt = 0; $attempt -lt $ATTEMPT_LIMIT; $attempt++) {
        try {
            ...
            $params = @{
                Method  = 'Get'
                Uri     = ('https://{0}.vault.azure.net/secrets/{1}?api-version=2025-07-01' -f $KeyVaultName, $SecretName)
                Headers = @{

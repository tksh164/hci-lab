...
@{
    'azloc24h2_2603' = @{
        'iso' = @{
            'en-us' = 'https://azurestackreleases.download.prss.microsoft.com/dbazure/AzureLocal/ComposedImage/12.2603.0.3012/AzureLocal24H2.26100.1742.LCM.12.2603.0.3012.x64.en-us.iso'
        }
        'updates' = @()
    }
    'azloc24h2_2602' = @{
        'iso' = @{
            'en-us' = 'https://azurestackreleases.download.prss.microsoft.com/dbazure/AzureLocal/WindowsPlatform/12.2602.0.3018/AzureLocal24H2.26100.1742.LCM.12.2602.0.3018.x64.en-us.iso'
        }
        'updates' = @()
    }
    'azloc24h2_2601' = @{
        'iso' = @{
            'en-us' = 'https://azurestackreleases.download.prss.microsoft.com/dbazure/AzureLocal/WindowsPlatform/12.2601.0.3137/AzureLocal24H2.26100.1742.LCM.12.2601.0.3137.x64.en-us.iso'
        }
        'updates' = @()
    }
    'azloc24h2_2512' = @{
    ...
    'ws2025' = @{
        'iso' = @{
            'en-us' = 'https://software-static.download.prss.microsoft.com/dbazure/998969d5-f34g-4e03-ac9d-1f9786c66749/26100.32230.260111-0550.lt_release_svc_refresh_SERVER_EVAL_x64FRE_en-us.iso'
            'ja-jp' = 'https://software-static.download.prss.microsoft.com/dbazure/998969d5-f34g-4e03-ac9d-1f9786c66749/26100.32230.260111-0550.lt_release_svc_refresh_SERVER_EVAL_x64FRE_ja-jp.iso'
        }
        'updates' = @(
            # OS
            'https://catalog.sf.dl.delivery.mp.microsoft.com/filestreamingservice/files/40c739e2-585a-4dce-bc12-1abb5f316301/public/windows11.0-kb5078740-x64_f569920344bf45a6c3eb619375a8066110d51ba9.msu',
            # .NET Framework
            'https://catalog.sf.dl.delivery.mp.microsoft.com/filestreamingservice/files/93ad5b40-17fe-459f-8b6d-a7e813ad9c72/public/windows11.0-kb5074831-x64-ndp481_485896c1de7b932dc51a4064b39f3cfdae2b5473.msu'
        )
    }
    'ws2022' = @{
        'iso' = @{
        ...
        'updates' = @(
            # OS
            'https://catalog.s.download.windowsupdate.com/c/msdownload/update/software/secu/2024/05/windows10.0-kb5037782-x64_a28aa2576fc6b120b127acfbb901d3546ba9db82.msu',  # For SSU of 2026-03
            'https://catalog.s.download.windowsupdate.com/d/msdownload/update/software/secu/2026/03/windows10.0-kb5078766-x64_97ad62f0b9975b31e3d9dc7b847fe92970cc0925.msu',
            # .NET Framework

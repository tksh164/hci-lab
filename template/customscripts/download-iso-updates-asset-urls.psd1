...
@{
    ...
    'ws2022' = @{
        ...
        'updates' = @(
            ...
            'https://catalog.s.download.windowsupdate.com/c/msdownload/update/software/secu/2026/01/windows10.0-kb5073457-x64_c194bd303ef4be76cd8ea256cf8e8c81682455f0.msu',
            # .NET Framework

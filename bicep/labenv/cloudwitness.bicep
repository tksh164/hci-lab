...
resource storageAccountNameSecret 'Microsoft.KeyVault/vaults/secrets@2022-11-01' = {
  parent: keyVault
...
resource storageAccountKeySecret 'Microsoft.KeyVault/vaults/secrets@2022-11-01' = {
  parent: keyVault
  name: secretNameForStorageAccountKey
  properties: {
    value: storageAccount.listKeys('2022-09-01').keys[0].value
  }
}
